...
proptest! {
    #[test]
    fn test_noise_agent_seed_determinism(
        // Test if seeded noise traders are deterministic regardless of seed value.
        seed in 0u64..100
    ) {
        ...
        for _ in 0..=10 {
            assert_eq!(noise_agent_1.generate_order(), noise_agent_2.generate_order());
        }
    }
}